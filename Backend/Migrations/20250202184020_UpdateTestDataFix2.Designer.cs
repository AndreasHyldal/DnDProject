...
namespace Backend.Migrations
{
    ...
    [Migration("20250202184020_UpdateTestDataFix2")]
    partial class UpdateTestDataFix2
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Backend.Models.Worktime", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Id = 3,
                            EmployeeId = 1,
                            End = new DateTime(2024, 2, 3, 20, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            Id = 4,
                            EmployeeId = 1,
                            End = new DateTime(2024, 2, 4, 14, 0, 0, 0, DateTimeKind.Unspecified),
                            Start = new DateTime(2024, 2, 4, 10, 0, 0, 0, DateTimeKind.Unspecified),
                            Task = "Bug fixes and testing"
                        },
                        new
                        {
                            Id = 5,
                            EmployeeId = 1,
                            End = new DateTime(2024, 2, 5, 14, 0, 0, 0, DateTimeKind.Unspecified),
                            Start = new DateTime(2024, 2, 5, 10, 0, 0, 0, DateTimeKind.Unspecified),
                            Task = "Bug fixes and testing"
                        },
                        new
                        {
                            Id = 6,
                            EmployeeId = 1,
                            End = new DateTime(2024, 2, 6, 16, 0, 0, 0, DateTimeKind.Unspecified),
                            Start = new DateTime(2024, 2, 6, 10, 0, 0, 0, DateTimeKind.Unspecified),
                            Task = "Bug fixes and testing"
                        },
                        new
                        {
                            Id = 7,
                            EmployeeId = 1,
                            End = new DateTime(2024, 2, 7, 16, 0, 0, 0, DateTimeKind.Unspecified),
                            Start = new DateTime(2024, 2, 7, 10, 0, 0, 0, DateTimeKind.Unspecified),
                            Task = "Bug fixes and testing"
                        },
                        new
                        {
